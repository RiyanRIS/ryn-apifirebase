...
exports.sendImage = async(from, buffer, caption = "") => {
  await conn.sendMessage(from, buffer, MessageType.image, { thumbnail: null, caption: caption })
}

exports.sendImageFromUrl = async(from, url, caption = "") => {
  await conn.sendMessage(from, { url: url }, MessageType.image, { thumbnail: null, caption: caption })
}
